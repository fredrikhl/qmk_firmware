...
[BASE] = LAYOUT_ergodox(
    ...
    KC_LCTRL,   KC_LGUI,    KC_LALT,    KC_GRAVE,   KC_DEL,

                                        KC_LEFT,    KC_RIGHT,
                                                    KC_UP,
                            KC_BSPC,    KC_DELT,    KC_DOWN,

    // right hand
    KC_RBRC,    KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       KC_MINS,
    TO(1),      KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_LBRC,
                KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOT,
    MO(3),      KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,
                            KC_INS,     KC_MINUS,   KC_EQUAL,   KC_QUOTE,   KC_RALT,
...
[SYMB] = LAYOUT_ergodox(
    ...
    KC_TRNS,    DE_EXLM,    DE_AT,      DE_LCBR,    DE_RCBR,    DE_PIPE,    TO(1),
    ...
    TO(3),      KC_UP,      KC_7,       KC_8,       KC_9,       DE_ASTR,    KC_F12,
...
[MDIA] = LAYOUT_ergodox(
    ...
    KC_TRNS,    KC_TRNS,    KC_BTN1,    KC_MS_U,    KC_BTN2,    KC_TRNS,    TO(2),
    ...
    // right hand
    KC_TRNS,    KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,
    XXXXXXX,    KC_TRNS,    KC_VOLD,    KC_MUTE,    KC_VOLU,    KC_TRNS,    KC_F12,
