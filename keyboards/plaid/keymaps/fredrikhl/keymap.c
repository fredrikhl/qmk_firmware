...
[_QWERTY] = LAYOUT_plaid_grid(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_RALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,  KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_LOWER] = LAYOUT_plaid_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, KC_0,    KC_DEL,  KC_END,  KC_PGDN
),
